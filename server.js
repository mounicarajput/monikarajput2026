...
app.get('/ten-rupee-homepage.html', (req, res) => res.sendFile(path.join(__dirname, 'ten-rupee-homepage.html')));
app.get('/ten-rupee-homepage', (req, res) => res.sendFile(path.join(__dirname, 'ten-rupee-homepage.html')));
